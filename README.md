...
5. Combines all the data to predict implicit ratings (1/0) using a 2-layer neural network
6.cHyperparameter tuned the hidden layer size using validation metrics
